...
const teachModeInput = document.getElementById("teachModeInput");
const teachSkillNameInput = document.getElementById("teachSkillNameInput");
...
function readFields() {
  return {
    ...
    preferredSurface: document.getElementById("surfaceInput").value,
    executionMode: document.getElementById("modeInput").value,
    maxSteps: Number(document.getElementById("maxStepsInput").value || 8),
    workspaceName: document.getElementById("workspaceInput").value.trim(),
    skillName: document.getElementById("skillInput").value.trim(),
    startUrl: document.getElementById("urlInput").value.trim(),
    desktopApp: document.getElementById("appInput").value.trim(),
    clickTarget: document.getElementById("clickTargetInput").value.trim(),
    typeTarget: document.getElementById("typeTargetInput").value.trim(),
    typeText: document.getElementById("typeTextInput").value.trim(),
    waitText: document.getElementById("waitTextInput").value.trim(),
    waitUrl: document.getElementById("waitUrlInput").value.trim(),
    captureLabel: document.getElementById("captureInput").value.trim(),
    stepsRaw: document.getElementById("stepsInput").value.trim(),
...
function fillExample(kind) {
  ...
  document.getElementById("surfaceInput").value = example.preferredSurface;
  document.getElementById("urlInput").value = example.startUrl;
  document.getElementById("appInput").value = example.desktopApp;
  document.getElementById("clickTargetInput").value = example.clickTarget;
  document.getElementById("typeTargetInput").value = example.typeTarget;
  document.getElementById("typeTextInput").value = example.typeText;
  document.getElementById("waitTextInput").value = example.waitText;
  document.getElementById("waitUrlInput").value = example.waitUrl;
  document.getElementById("captureInput").value = example.captureLabel;
