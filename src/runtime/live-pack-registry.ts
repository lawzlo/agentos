...
import {
  ...
  findMatchingOutlookVisibleThread,
  findOutlookInboxRecoveryPoint,
  hasOutlookInboxRecoveryHint,
  isOutlookTargetUnreadStillVisible,
  isOutlookThreadOpenForTarget,
  traceOutlookAnalysisError,
  traceOutlookThreadState
} from "./outlook-pack-utils.js";
import {
...
import {
  ...
  normalizeWeChatSummary,
  type WeChatSemanticFacts
} from "./wechat-semantic-facts.js";
import {
  deriveWeChatComposerFallback,
  deriveWeChatConversationListPoint,
  extractWeChatThreadContext,
  findWeChatComposeCandidate,
  findWeChatSendCandidate,
  findWeChatThreadTargetCandidate,
  findWeChatUnreadCandidate,
  hasWeChatUnreadEvidence,
  isWeChatCandidateInThreadBody,
  isWeChatUiChrome,
  pickWeChatComposeQuery,
  pickWeChatSendQuery,
  rankWeChatUnreadCandidates,
  scoreWeChatCandidate
} from "./wechat-pack-utils.js";
import {
