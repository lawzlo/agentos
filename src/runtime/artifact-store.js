...
export class ArtifactStore {
    ...
    async #allocateFile(workspace, kind, label, extension = "txt") {
    ...
    async writeText({ workspace, taskId, traceId, kind, label, content }) {
    ...
    async writeJson({ workspace, taskId, traceId, kind, label, payload }) {
    ...
    async registerExistingFile({ taskId, traceId, kind, label, filePath, metadata = {} }) {
        return this.store.createArtifact({
            taskId,
            traceId,
            kind,
